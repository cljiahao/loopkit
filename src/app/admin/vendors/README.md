...
- `page.tsx` — `AdminVendorsPage`: fetches `listVendors()` and `listPendingUpgradeRequests()`, renders the pending-requests section and a vendor table (both `ElevatedCard`-wrapped) with Pro badges/toggles.
