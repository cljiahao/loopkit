...
- `page.tsx` — `AdminOverviewPage`: platform-wide totals (programs, customers, stamps, rewards) and a recent cross-shop activity feed.
- `programs/`
- `stat.tsx` — `Stat`: a small labeled-value tile used across the admin overview and program detail pages.
- `vendors/`
